...
const defaultTitles: Record<string, string> = {
  'getting-started': 'Guía de Inicio - Panel de Plataforma',
  'modules': 'Módulos del Panel - Panel de Plataforma',
  'workflows': 'Flujos de Trabajo - Panel de Plataforma',
  'integrations': 'Integraciones - Panel de Plataforma',
  'troubleshooting': 'Solución de Problemas - Panel de Plataforma',
};

export default function PlatformDocPage() {
  ...
  useEffect(() => {
    const loadDoc = async () => {
      try {
        setLoading(true);
        const response = await fetch(`/docs/PLATFORM-OWNER/${docFile}`);
        if (!response.ok) {
