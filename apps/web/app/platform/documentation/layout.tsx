...
const docsTabs = [
  ...
  { 
    href: '/platform/documentation/getting-started', 
    label: 'documentation.getting_started', 
    icon: Rocket,
    doc: 'getting-started'
  },
  { 
    href: '/platform/documentation/modules', 
    label: 'documentation.modules', 
    icon: Puzzle,
    doc: 'modules'
  },
  { 
    href: '/platform/documentation/workflows', 
    label: 'documentation.workflows', 
    icon: Workflow,
    doc: 'workflows'
  },
  { 
    href: '/platform/documentation/integrations', 
    label: 'documentation.integrations', 
    icon: Plug,
    doc: 'integrations'
  },
  { 
    href: '/platform/documentation/troubleshooting', 
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {t('documentation.description') || 'Complete platform administration panel documentation'}
        </p>
      </div>

      {/* Navigation Tabs */}
      <div className="no-print">
        <Tabs value={pathname || '/platform/documentation'} className="w-full">
