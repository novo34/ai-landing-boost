...
export default function PlatformDocsPage() {
  ...
  useEffect(() => {
    const loadDoc = async () => {
      try {
        setLoading(true);
        const response = await fetch('/docs/PLATFORM-OWNER/00-Overview.md');
        if (!response.ok) {
  ...
  return (
    <div className="flex gap-6">
      ...
      <div className="flex-1">
        ...
        <DocsActions content={content} title={t('documentation.platform_title') || 'Platform Administration Panel Documentation'} />
